...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar key = exports.key = '378ef23321788deb13758dc2fd450344';\nvar url = exports.url = 'https://cors-anywhere.herokuapp.com/';\n\n//# sourceURL=webpack:///./src/js/config.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ../config */ \"./src/js/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Search = function () {\n    function Search(query) {\n        _classCallCheck(this, Search);\n\n        this.query = query;\n    }\n\n    _createClass(Search, [{\n        key: 'getResults',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var _key, _url, res;\n\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.prev = 0;\n                                _key = '378ef23321788deb13758dc2fd450344';\n                                _url = 'https://cors-anywhere.herokuapp.com/';\n                                _context.next = 5;\n                                return (0, _axios2.default)(_url + 'https://www.food2fork.com/api/search?key=' + _key + '&q=' + this.query);\n\n                            case 5:\n                                res = _context.sent;\n\n\n                                this.result = res.data.recipes;\n\n                                _context.next = 12;\n                                break;\n\n                            case 9:\n                                _context.prev = 9;\n                                _context.t0 = _context['catch'](0);\n\n                                console.log(_context.t0);\n\n                            case 12:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[0, 9]]);\n            }));\n\n            function getResults() {\n                return _ref.apply(this, arguments);\n            }\n\n            return getResults;\n        }()\n    }]);\n\n    return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/model/Search.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clearSearch = exports.clearFields = exports.renderView = exports.getInput = undefined;\n\nvar _dom = __webpack_require__(/*! ./dom */ \"./src/js/views/dom.js\");\n\nvar getInput = exports.getInput = function getInput() {\n    return _dom.elements.inputField.value;\n};\nvar render = function render(recipe) {\n    var mark = '<li>\\n    <a class=\"results__link\" href=\"#' + recipe.recipe_id + '\">\\n        <figure class=\"results__fig\">\\n            <img src=\"' + recipe.image_url + '\" alt=\"Test\">\\n        </figure>\\n        <div class=\"results__data\">\\n            <h4 class=\"results__name\">' + limitTitle(recipe.title) + '</h4>\\n            <p class=\"results__author\">' + recipe.publisher + '</p>\\n        </div>\\n    </a>\\n</li>';\n    _dom.elements.recipeList.insertAdjacentHTML('beforeend', mark);\n};\nvar limitTitle = function limitTitle(title) {\n    var limit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 17;\n\n    var newTitle = [];\n    if (title.length > limit) {\n        title.split(' ').reduce(function (acc, cur) {\n            if (acc + cur.length < 17) {\n                newTitle.push(cur);\n            }\n            return acc + cur.length;\n        }, 0);\n        return newTitle.join(' ') + ' ...';\n    }\n    return title;\n};\nvar showButton = function showButton(page, type) {\n    return '  \\n<button class=\"btn-inline results__btn--' + type + '\" data-goto=' + (type === 'prev' ? page - 1 : page + 1) + '>\\n    <span>Page ' + (type === 'prev' ? page - 1 : page + 1) + '</span>\\n    <svg class=\"search__icon\">\\n        <use href=\"img/icons.svg#icon-triangle-' + (type === 'prev' ? 'left' : 'right') + '\"></use>\\n    </svg>\\n</button>';\n};\nvar renderPageBtn = function renderPageBtn(page, numPage, resultPerPage) {\n    var pages = Math.ceil(numPage / resultPerPage);\n    var createButton = void 0;\n    if (page == 1 && pages > 1) {\n        //Only Button to go for next page\n        createButton = showButton(page, 'next');\n    } else if (page == pages && pages > 1) {\n        //only button to go for previous page\n        createButton = showButton(page, 'prev');\n    } else if (page > 1) {\n        //both the buttons\n        createButton = '' + showButton(page, 'prev') + showButton(page, 'next');\n    }\n    _dom.elements.resultPages.insertAdjacentHTML('afterbegin', createButton);\n};\nvar renderView = exports.renderView = function renderView(renderArray) {\n    var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;\n    var numResult = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10;\n\n    var start = (page - 1) * numResult;\n    var end = page * numResult;\n    renderArray.slice(start, end).forEach(function (element) {\n        return render(element);\n    });\n    renderPageBtn(page, renderArray.length, numResult);\n};\nvar clearFields = exports.clearFields = function clearFields() {\n\n    _dom.elements.inputField.value = '';\n};\nvar clearSearch = exports.clearSearch = function clearSearch() {\n    _dom.elements.recipeList.innerHTML = ' ';\n    _dom.elements.resultPages.innerHTML = ' ';\n};\n\n//# sourceURL=webpack:///./src/js/views/searchView.js?");

/***/ }),

/***/ 0:
/*!*********************************************************!*\
  !*** multi idempotent-babel-polyfill ./src/js/index.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! idempotent-babel-polyfill */\"./node_modules/idempotent-babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/js/index.js */\"./src/js/index.js\");\n\n\n//# sourceURL=webpack:///multi_idempotent-babel-polyfill_./src/js/index.js?");
